...
export const lo = {
  ...
  "email.reset.subject": "ຕັ້ງລະຫັດຜ່ານ {schoolName} ຄືນໃໝ່",
  "email.reset.heading": "ເລືອກລະຫັດຜ່ານໃໝ່",
  "email.reset.body1":
    "ພວກເຮົາໄດ້ຮັບຄຳຮ້ອງຂໍໃຫ້ຕັ້ງລະຫັດຜ່ານຄືນໃໝ່ສຳລັບທີ່ຢູ່ອີເມວນີ້. ກະລຸນາໃຊ້ປຸ່ມຂ້າງລຸ່ມນີ້ເພື່ອເລືອກລະຫັດຜ່ານໃໝ່.",
  "email.reset.button": "ຕັ້ງລະຫັດຜ່ານໃໝ່",
  "email.reset.expiry":
    "ລິ້ງນີ້ຈະໝົດອາຍຸພາຍໃນໜຶ່ງຊົ່ວໂມງ ແລະ ໃຊ້ໄດ້ພຽງເທື່ອດຽວ.",
  "email.reset.ignore":
    "ຖ້າທ່ານບໍ່ໄດ້ຮ້ອງຂໍສິ່ງນີ້ ທ່ານສາມາດບໍ່ສົນໃຈອີເມວນີ້ໄດ້ — ບໍ່ມີຫຍັງປ່ຽນແປງ ແລະ ລະຫັດຜ່ານປັດຈຸບັນຂອງທ່ານຍັງໃຊ້ໄດ້ຢູ່.",
  "email.reset.fallback":
    "ຖ້າປຸ່ມໃຊ້ບໍ່ໄດ້ ໃຫ້ສຳເນົາ ແລະ ວາງລິ້ງນີ້ໃສ່ໃນເບຣົາເຊີຂອງທ່ານ:",
